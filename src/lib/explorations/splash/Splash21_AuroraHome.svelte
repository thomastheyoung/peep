...
<div class="container">
	...
	<div class="screen">
		<!-- Aurora layers — each has independent multi-axis movement -->
		...
		<!-- Logo — fades in center, then rises to top -->
		<div class="logo-track">
			<h1 class="logo">peep</h1>
		</div>

		<!-- Help panel — fades in after logo settles at top -->
...
<style>
	...
	/*
	 * Each layer uses a DIFFERENT animation name with a unique wandering path.
	 * Durations are chosen to be non-multiples of each other so the layers
	 * never synchronize, producing fluid, organic motion.
	 */
